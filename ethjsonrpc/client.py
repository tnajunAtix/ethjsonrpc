...
################################################################################
    ...
    def create_contract(self, from_, code, gas, sig=None, args=None, gas_price=None):
        '''
        ...
        return self.eth_sendTransaction(from_address=from_, gas=gas, data=code, gas_price=gas_price)
